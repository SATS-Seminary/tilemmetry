 ...
 * @author  2018 South African Theological Seminary
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
defined('MOODLE_INTERNAL') || die();

$functions = array(
    'theme_tilemmetry_create_section_instance' => array(
        'classname'     => 'theme_tilemmetry\external\api',
        'methodname'    => 'create_section_instance',
        'description'   => 'Create New Section Instance',
        'type'          => 'write',
        'ajax'          => true,
    ),
    'theme_tilemmetry_delete_section_instance' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_fetch_all_instances' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_get_frontpage_section_courses_in_category' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_save_frontpage_settings' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_save_sections_order' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_update_section_instance' => array(
        'classname'     => 'theme_tilemmetry\external\api',
    ...
    'theme_tilemmetry_update_section_visibility' => array(
        'classname'     => 'theme_tilemmetry\external\api',
