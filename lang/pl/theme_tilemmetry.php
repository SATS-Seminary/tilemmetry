...
$string['enabledashboardelementsdesc'] = 'Odznacz, aby wyłączyć widget SATS Tilemmetry w kokpicie.';
...
$string['poweredby'] = 'Wspierane przez SATS Tilemmetry';
...
$string['abouttilemmetry'] = 'O SATS Tilemmetry';

$string['tilemmetrysettings'] = 'Ustawienia Tilemmetry';
...
$string['newupdatemessage'] = 'Dostępna jest nowa aktualizacja dla Tilemmetry.';
$string['currentversionmessage'] = 'Aktualna wersja to: ';
$string['downloadupdate'] = 'Pobierz aktualizację';
$string['latestversionmessage'] = 'Korzystasz z najnowszej wersji Tilemmetry.';
$string['ratetilemmetry'] = 'Oceń Tilemmetry';
$string['fullname']  = 'Pełna nazwa';
$string['providefeedback'] = 'Przekaż nam opinię o Tilemmetry';
