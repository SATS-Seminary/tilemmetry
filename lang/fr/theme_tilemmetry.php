...
$string['pluginname'] = 'SATS Tilemmetry';
...
$string['enabledashboardelementsdesc'] = 'Désélectionnez pour désactiver le widget personnalisé EdWiser Tilemmetry sur le tableau de bord';
...
$string['configtitle'] = 'SATS Tilemmetry';
...
$string['olddashboard'] = 'Vous avez un vieux plugin Tilemmetry Block installé sur votre système. Pour bénéficier des nouvelles fonctionnalités et paramètres, veuillez mettre à jour votre plug-in Tilemmetry Block avec la dernière version.';
...
$string['poweredby'] = 'Powered by SATS Tilemmetry';
...
$string['abouttilemmetry'] = 'About SATS Tilemmetry';

$string['tilemmetrysettings'] = 'Tilemmetry Settings';
...
$string['newupdatemessage'] = 'New Update Available for Tilemmetry.';
$string['currentversionmessage'] = 'Your current version is ';
$string['downloadupdate'] = 'Download Update';
$string['latestversionmessage'] = 'You are using the latest version of Tilemmetry.';
$string['ratetilemmetry'] = 'Rate Tilemmetry';
$string['fullname']  = 'Full Name';
$string['providefeedback'] = 'Please provide your feedback about Tilemmetry';
...
$string['migratormessge'] = '<p> Bienvenue dans le tout nouveau design de la page d’accueil d’SATS Tilemmetry. Nous avons constaté que vos paramètres de page d\'accueil étaient anciens. Aimez-vous migrer ces paramètres? </P> <p> <strong> Migrer </strong>: de nouveaux blocs seront créés à partir d\'anciens paramètres. </Br> <strong> Annuler </strong>: vous pouvez créer une page d\'accueil. manuellement et ce message ne s\'affichera plus. </p>';
...
// Capability String
$string['tilemmetry:editfrontpage'] = 'Modifier la page d\'accueil';
