...
$string['enabledashboardelementsdesc'] = 'Uncheck to disable SATS Tilemmetry custom widget on dashboard.';
...
$string['olddashboard'] = 'Auf Ihrem System ist ein altes Tilemmetry-Block-Plugin installiert. Um neue Funktionen und Einstellungen zu erhalten, aktualisieren Sie bitte Ihr Tilemmetry Block-Plugin auf die neueste Version.';
...
$string['poweredby'] = 'Von SATS Tilemmetry betrieben';
...
$string['abouttilemmetry'] = 'Über SATS Tilemmetry';

$string['tilemmetrysettings'] = 'Tilemmetry Einstellungen';
...
$string['newupdatemessage'] = 'Neue Update für Tilemmetry steht zur Verfügung.';
$string['currentversionmessage'] = 'Ihre aktuelle Version ist';
$string['downloadupdate'] = ' Update herunterladen';
$string['latestversionmessage'] = 'Sie benutzen die neueste Version von Tilemmetry.';
$string['ratetilemmetry'] = 'Tilemmetry bewerten';
$string['fullname']  = 'Voller Name';
$string['providefeedback'] = 'Bitte geben Sie Ihren Feedback von Tilemmetry ein';
...
// Capability String
$string['tilemmetry:editfrontpage'] = 'Frontpage bearbeiten';
