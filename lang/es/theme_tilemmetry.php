...
$string['enabledashboardelementsdesc'] = 'Deseleccione para desactivar los widgets de SATS Tilemmetry en la Barra de Tareas.';
...
$string['abouttilemmetry'] = 'Acerca de SATS Tilemmetry';

$string['tilemmetrysettings'] = 'Configuración de Tilemmetry';
...
$string['newupdatemessage'] = 'Nueva actualización disponible de Tilemmetry.';
$string['currentversionmessage'] = 'La versión actual es ';
$string['downloadupdate'] = 'Descargar actualización';
$string['latestversionmessage'] = 'Está utilizando la última versión de Tilemmetry.';
$string['ratetilemmetry'] = 'Valore Tilemmetry';
$string['fullname']  = 'Nombre completo';
$string['providefeedback'] = 'Denos su opinión sobre Tilemmetry';
