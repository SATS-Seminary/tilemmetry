...
class toolbox {
    ...
    static private function check_corerenderer() {
        ...
        if (empty($us->corerenderer)) {
            // Use $OUTPUT unless is not a Tilemmetry or child core_renderer which can happen on theme switch.
            global $OUTPUT;
            if (property_exists($OUTPUT, 'tilemmetry')) {
                ...
                // Fallback check.
                if (($corerenderer != null) && (property_exists($corerenderer, 'tilemmetry'))) {
                    ...
                    if (($corerenderer != null) && (property_exists($corerenderer, 'tilemmetry'))) {
                        ...
                        $us->corerenderer = $PAGE->get_renderer('theme_tilemmetry', 'core');
                    }
                }
            }
        }
