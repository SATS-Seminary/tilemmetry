...
/**
 * SATS Tilemmetry H5P Renderer for Custom CSS
...
if (file_exists($h5prenderer)) {
    ...
    /**
     * Class theme_tilemmetry_mod_hvp_renderer
     */
    class theme_tilemmetry_mod_hvp_renderer extends mod_hvp_renderer {
        ...
        protected function get_style_url($content) {
            ...
            return \moodle_url::make_file_url("$CFG->wwwroot/pluginfile.php",
                "/$syscontext->id/theme_tilemmetry/hvp/$itemid/themehvp.css");
        }
    }
}
