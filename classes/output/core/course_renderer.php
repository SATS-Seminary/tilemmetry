...
class course_renderer extends \core_course_renderer {
    ...
    public function frontpage_available_courses() {
        ...
        $latestcard = get_config('theme_tilemmetry', 'enablenewcoursecards');
        ...
        <div class='row'>
            <div class='col-12 text-right'>
                <a href='{$CFG->wwwroot}/course' class='btn btn-primary'>".get_string('viewallcourses', 'theme_tilemmetry')."</a>
            </div>
        </div>";
