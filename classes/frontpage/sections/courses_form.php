...
trait courses_form {
    ...
    private function coursesform(&$mform, $formdata, $configdata) {
        ...
        $defaultval = (!isset($formdata[$title])) ? "" : $formdata[$title];
        $dates = array(
            'all' => get_string('all', 'theme_tilemmetry'),
            'inprogress' => get_string('coursessectioninprogress', 'theme_tilemmetry'),
            'future' => get_string('future', 'theme_tilemmetry'),
            'past' => get_string('past', 'theme_tilemmetry')
        );
