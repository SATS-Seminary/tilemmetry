...
use \theme_tilemmetry\utility as utility;
...
trait courses_data {
    ...
    private function get_category_details($categories) {
        ...
        foreach ($categories as $key => $category) {
            ...
            $count = \theme_tilemmetry\utility::get_courses(true, null, $category->id, 0, 0, null, null);
    ...
    public function get_courses_from_category($categories, $date) {
        ...
        foreach ($categories as $key => $value) {
            \theme_tilemmetry\utility::$childCategories = array();
            $result = null;
            $obj->category = $value;
            $result = \theme_tilemmetry\utility::get_course_cards_content($obj, $date);
