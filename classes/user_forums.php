...
class user_forums {
    ...
    public function __construct($userorid = false, $forumlimit = false) {
        $this->user = \theme_tilemmetry\utility::get_user($userorid);
    ...
    protected function populate_forums() {
        \theme_tilemmetry\utility::swap_global_user($this->user->id);
        ...
        // Currently we are using \theme_tilemmetry\utility::swap_global_user as a hack for the following function (MDL-51353) :
        ...
        \theme_tilemmetry\utility::swap_global_user(false);
    }
}