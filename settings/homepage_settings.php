...
// Homepage Settings
    ...
    $setting = new admin_setting_configselect(
        ...
        array(
            ...
            1 => get_string('frontpagedesignnew', 'theme_tilemmetry'),
        )
    );
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    if (\theme_tilemmetry\toolbox::get_setting('frontpagechooser')) {
        $page->add(new admin_setting_description('newhomepagedescription', '', get_string('newhomepagedescription', 'theme_tilemmetry')));
        $page->add(new admin_setting_description('newhomepagedescription1', '', ''));
    } else if (!\theme_tilemmetry\toolbox::get_setting('frontpagechooser')) {
        $page->add(new admin_setting_heading(
