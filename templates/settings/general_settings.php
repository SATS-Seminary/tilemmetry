 ...
 */
 ...
 // General settings
    ...
    // Course animation to be shown on Archive page
   ...
   $name = 'theme_tilemmetry/enablecoursestats';
    ...
    $name = 'theme_tilemmetry/courseeditbutton';
    $title = get_string('courseeditbuttonsetting', 'theme_tilemmetry', null, true);
    $description = get_string('courseeditbuttonsetting_desc', 'theme_tilemmetry', null, true);
